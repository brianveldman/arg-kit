...
'Get-ArgSecurityDefenderForCloudCoverage', 'Get-ArgSecurityPurgeProtectionKeyVaults', 'Get-ArgSecurityNsgOpenManagementPorts', 'Get-ArgSecuritySoftDeleteDisabledKeyVaults', 'Get-ArgSecuritySqlServersPublicNetworkAccess', 'Get-ArgCostHybridUseBenefitsNotEnabled', 'Get-ArgCostHybridUseBenefitsEnabled', 'Get-ArgCostSavingsSummary', 'Get-ArgCostStoppedNotDeallocatedVMs', 'Get-ArgCostUnassociatedStandardPublicIPs', 'Get-ArgCostOldSnapshots', 'Get-ArgCostAvdHostPoolsWithoutScalingPlan', 'Get-ArgCostPremiumDisksOnDeallocatedVMs', 'Get-ArgCostUnattachedPremiumDisks', 'Get-ArgCostIdleGateways', 'Get-ArgSecurityBlobPublicAccessStorageAccounts', 'Get-ArgSecurityAppServicesWithoutHttpsOnly', 'Get-ArgReliabilityVmsWithoutAvailabilityZone', 'Get-ArgReliabilityLocallyRedundantStorageAccounts', 'Get-ArgSecuritySharedKeyAccessStorageAccounts', 'Get-ArgGovernanceResourcesMissingRequiredTags', 
...
'Get-ArgDeprecationTlsStorageAccounts', 'Get-ArgDeprecationTlsSqlServers', 'Get-ArgDeprecationP2SEntraManualVpnGateways', 'Get-ArgDeprecationRetiredVmSizes', 'Get-ArgMonitorAlertsLast2Hours', 'Get-ArgMonitorActiveServiceHealthAlerts', 'Get-ArgMonitorActivePlannedMaintenanceEvents', 'Get-ArgOverviewReport')
